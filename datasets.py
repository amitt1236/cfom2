...
class InteractionsDataset(Dataset):
    def __init__(self, smiles, smiles_backbones, smiles_chains, assay_ids, assay_types, labels, protein_embeddings,
        ...
        for cur_smiles, cur_backbone, cur_chains, cur_assay_id, cur_assay_type, cur_label in tqdm(zip(smiles, smiles_backbones, smiles_chains, assay_ids, assay_types, labels), total=len(smiles)):
